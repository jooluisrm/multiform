...
const Step2 = () => {
    ...
    const navigateToStep3 = () => {
        if (ctx?.level === null) return alert("Preencha o seu nivel para continuar!");
        router.push('/step3');
    };
        ...
        <div className="flex justify-center">
            ...
            <div className="py-10 pl-10 flex-1">
                ...
                <div>
                    ...
                    <div className="mt-5">
                        <Button2 text="Voltar" onClick={navigateToHome} />
                        <Button text="Próximo" onClick={navigateToStep3} />
                    </div>
